...
// DO NOT EDIT.
// source: org/podcastindex/podping/hivewriter/podping_write.capnp


pub mod podping_write {
  #[derive(Copy, Clone)]
  pub struct Owned(());
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_iri(self) -> ::capnp::Result<::capnp::text::Reader<'a>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_iri(self) -> ::capnp::Result<::capnp::text::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_iri(&mut self, value: ::capnp::text::Reader<'_>)  {
      self.builder.get_pointer_field(0).set_text(value);
    }
    #[inline]
    pub fn init_iri(self, size: u32) -> ::capnp::text::Builder<'a> {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xf488_f68e_804a_8fb5;
  }
}
