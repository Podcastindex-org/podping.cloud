...
# modified to write to feather file format
#
...
# TODO working on converting export to csv to export to feather as a pandas data.frame, see:
# https://rstudio-pubs-static.s3.amazonaws.com/207316_edcc0ea0a7c04ea5a63833aaea7051fb.html
